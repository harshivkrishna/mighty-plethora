      ...
      >
        {testimonials.map((testimonial, index) => (
          <SwiperSlide key={index} className="flex items-center justify-center swiper-slide ">
            ...
            >
              <div className="absolute -top-1 left-0 w-8 h-8 text-yellow-500 rounded-full flex items-center justify-center transform -translate-x-1/2 -translate-y-1/2">
                <span className="text-3xl">+</span>
              </div>
              <div className="absolute right-0 -top-1 w-8 h-8  text-yellow-500 rounded-full flex items-center justify-center transform translate-x-1/2 -translate-y-1/2">
              <span className="text-3xl">+</span>
              </div>
              <div className="absolute -bottom-7 left-0 w-8 h-8 text-yellow-500 rounded-full flex items-center justify-center transform -translate-x-1/2 -translate-y-1/2">
                <span className="text-3xl">+</span>
              </div>
              <div className="absolute -bottom-7 right-0 w-8 h-8 text-yellow-500 rounded-full flex items-center justify-center transform translate-x-1/2 -translate-y-1/2">
                <span className="text-3xl">+</span>
              </div>
